...
#container_content {
  ...
  display: block;
  background-image: url(/pentaho-style<%= instance %>/images/login/middle_shadows.png);
...
#container_footer {
  ...
  display: block;
  background-image: url(/pentaho-style<%= instance %>/images/login/middle_shadows_footer.png);
  background-repeat:no-repeat;
}
#message {
  color: #FFF;
...
.dark {
  background-image: url(/pentaho-style<%= instance %>/images/login/content_bg.png);
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr height="94">
    <td bgcolor="#FFFFFF"><div id="container_header"><div id="links"><a href="http://www.pentaho.com" target="_blank">www.pentaho.com</a> | <a href="http://www.pentaho.com/contact/?puc=y" target="_blank"><%%=Messages.getString("UI.PUC.LOGIN.CONTACT_US")%></a></div>
        ...
        <a href="http://www.pentaho.com" target="_blank"><img src="/pentaho-style<%= instance %>/images/login/logo.png" alt="Pentaho Corporation" width="224" height="94" border="0" /></a></div></td>
  </tr>
  <tr height="334">
