name 'yguenane-pentaho'
version '0.0.1'
summary 'A Pentaho puppet module that allows easy Pentaho BI Server deployment from 3.8.0 to latest version'
description "This module aims to resolve different of a Pentaho instanllation aspect
