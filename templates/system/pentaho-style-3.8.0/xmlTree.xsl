...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
	...
	<xsl:template match="/">
				...
				<script type="text/javascript">
					...
					openImg.src = "/pentaho-style<%= instance %>/images/btn_minus.png";
					var closedImg = new Image();
					closedImg.src = "/pentaho-style<%= instance %>/images/btn_plus.png";
				...
				<tr>
					<td>
						<img>
							...
							<xsl:attribute name="src">/pentaho-style<%= instance %>/images/btn_plus.png</xsl:attribute>
	...
	<xsl:template match="leaf">
		<table>
			<tr>
				<td>
					<img>
						<xsl:attribute name="src">/pentaho-style<%= instance %>/images/solution_file.png</xsl:attribute>
					</img>
				</td>
				<td>
