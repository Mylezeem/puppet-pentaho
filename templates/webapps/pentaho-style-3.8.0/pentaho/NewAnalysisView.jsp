...
<table border='0' cellpadding='0' cellspacing='0' width="100%"
 ...
 %>
		<table border="0" cellpadding="0" cellspacing="0" width="350">
			<tr>
				<td width="10"><img
					src="/pentaho-style<%= instance %>/images/grey_top_left.png" width="10" height="9" /></td>
				<td bgcolor="#dedede"><img src="/pentaho-style<%= instance %>/images/Clr.png"
					width="341" height="2" /></td>
				<td width="10"><img
					src="/pentaho-style<%= instance %>/images/grey_top_right.png" width="10"
					height="9" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td><img src="/pentaho-style<%= instance %>/images/grey_bottom_left.png"
					width="10" height="10" /></td>
				<td bgcolor="#dedede"><img src="/pentaho-style<%= instance %>/images/Clr.png"
					width="341" height="2" /></td>
				<td><img src="/pentaho-style<%= instance %>/images/grey_bottom_right.png"
					width="10" height="10" /></td>
			</tr>
		</table>
		<%
