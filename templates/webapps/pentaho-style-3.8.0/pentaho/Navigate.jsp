...
<div id="splash" style="width:100%;height:340px;position:absolute;top:150px;z-index:10;display:block">
  <center>
  <div style="width:480px;height:320px;background-color:white;background-image: url(/pentaho-style<%= instance %>/splash.png);border:1px solid #FF6113">
    <img src="/pentaho-style<%= instance %>/active/logo.png" border="0"/>
    <p/>
    <table width="470">
      <tr>
        <td>
