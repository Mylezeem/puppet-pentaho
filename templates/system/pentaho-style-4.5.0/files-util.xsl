...
<xsl:output method="html" encoding="UTF-8" />
	...
	<xsl:template name="setupFly">
      ...
      <tr>
         <td width="5" height="9"><img border="0" src="/pentaho-style<%= instance %>/images/fly-top-left.png"/></td>
      ...
      <tr class="flyContent">
         <td valign="top" style="background-image: url(/pentaho-style<%= instance %>/images/fly-left.png);background-repeat: repeat-y; height: 171px;" colspan="2">
			<a href="javascript:void" onclick="changeFlyTab( 1 ); return false;">
				<img id="img-t1" src="/pentaho-style<%= instance %>/images/btn_info_active.png" alt="Info" border="0" />
			</a>
			<br />
			<a href="javascript:void" onclick="changeFlyTab( 2 ); return false;">
				<img id="img-t2" src="/pentaho-style<%= instance %>/images/btn_actions.png" border="0" />
			</a>
		</td>
		<td>
			<table border="0" cellpadding='0' cellspacing='0' style="vertical-align:bottom">
										...
										<div id="flyTab1" style="display:block;padding:0px;margin:0px">
											...
											<div id="flyDesc1" class="flyDesc">
												...
												<p>xx</p>
													...
													<td style="padding:5px;width:140px"><img id="flyimg" border="0" src="/pentaho-style<%= instance %>/images/spacer.gif" width="140" height="140" style="display:block"/></td>
												</tr>
											</table>
										</div>
      ...
      <tr>
         ...
         <td colspan="2"><img src="/pentaho-style<%= instance %>/images/fly-bot.png" height="16" width="100%"/></td>
