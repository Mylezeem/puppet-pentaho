...
%>
    ...
    <div id="selections" style="position:absolute;width: 345px; height: 200px;top:40px; left:5px; border:0px">
			...
			<tr>
    				<td valign="top">
      				<table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin:0px; padding:0px">
          				<tr>
            					<td style="background-image: url(/pentaho-style<%= instance %>/images/fly-top-left1.png); height: 25px; width: 25px;">
            						&nbsp;
            					</td>
            					<td style="background-image: url(/pentaho-style<%= instance %>/images/fly-top1.png); width: 100%; ">
								<span style="font: normal 1.1em Tahoma, 'Trebuchet MS', Arial;">Select Sales Thresholds</span>
						</td>
                                             <!-- Keep this for a backup
            					<td width="100%" style="background-image: url(/pentaho-style<%= instance %>/images/fly-top1.png); background-repeat: repeat-x; height: 25px; width: 100%; margin:0px; padding:0px ">
          				...
          				<tr>
            					<td colspan="2" style="background-color: #e5e5e5;">
									...
									<tr>
                  						<td style="background-image: url(/pentaho-style<%= instance %>/images/fly-left1.png); background-repeat: repeat-y; height: 10px; padding: 0px 5px 0px 0px;">
											<img border="0" src="/pentaho-style<%= instance %>/images/fly-left1.png" />
										</td>
										<td colspan="2">
                						...
                						<tr style="background-color: #e5e5e5;">
                  						<td style="background-image: url(/pentaho-style<%= instance %>/images/fly-left1.png); background-repeat: repeat-y; height: 10px; padding: 0px 5px 0px 0px;">
								<img border="0" src="/pentaho-style<%= instance %>/images/fly-left1.png" /></td>
          				...
          				<tr>
            					<td style="height: 25px; width: 25px;">
            						<img border="0" src="/pentaho-style<%= instance %>/images/fly-bot-left1.png" /><br /> 
            					</td>

            					<td               style="background-image: url(/pentaho-style<%= instance %>/images/fly-bot1.png); background-repeat: repeat-x"><img border="0" src="/pentaho-style<%= instance %>/images/fly-bot1.png" /><br /></td>
          				</tr>
      				</table>
      			</td>
		...
		<br/>
		<center>
			<img border="0" src="/pentaho-style<%= instance %>/images/pentaho_googlemap_white.png" style="padding-top:5px"/>
		</center>
    				...
    				<td valign="top">
      				<table border="0" cellpadding="0" cellspacing="0" width="100%" xheight="470" style="margin:0px; padding:0px">
          				<tr>
            					<td colspan="2"  valign="top" style="background-color: #e5e5e5;">
            						<table width="100%" border="0" cellspacing="1" cellpadding="0" height="100%">
               						...
               						<tr style="background-color: #e5e5e5;">
                  						<td style="background-image: url(/pentaho-style<%= instance %>/images/fly-left1.png); background-repeat: repeat-y; padding: 0px 5px 0px 0px;">
											&nbsp;
										</td>
          				...
          				<tr>
            					...
            					<td width="100%" style="background-image: url(/pentaho-style<%= instance %>/images/fly-bot1.png); background-repeat: repeat-x">
            						<img border="0" src="/pentaho-style<%= instance %>/images/fly-bot1.png" /><br />
            					</td>
          				</tr>
      				</table>
      			</td>
